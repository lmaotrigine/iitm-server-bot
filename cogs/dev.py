...
class Dev(commands.Cog):
    ...
    def get_syntax_error(self, e: SyntaxError):
        if e.text is None:
    ...
    async def eval(self, ctx: Context, *, body: str):
        ...
        func: Callable[..., Coroutine[Any, Any, Any]] = env["func"]
        try:
