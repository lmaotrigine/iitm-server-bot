...
class Verification(commands.Cog):
    ...
    async def create(self, ctx: Context):
        await ctx.channel.send(
            "Join our exclusive community and gain access to private channels and premium content by verifying your "
            "email address. Click the button below to complete the process and unlock all the benefits of being a part "
            "of our server.",
            view=Menu(),
        )
