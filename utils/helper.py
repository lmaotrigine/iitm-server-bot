...
if TYPE_CHECKING:
    from cogs._types import Context
...
def send_email(name: str, roll_no: str, _link: bytes, /):
    """
    ...
    configuration.api_key['api-key'] = os.environ.get("SIB_API_KEY")  # type: ignore # sib_api_v3_sdk is not typed
    ...
    api_instance.send_transac_email(send_smtp_email)  # type: ignore # sib_api_v3_sdk is not typed.
